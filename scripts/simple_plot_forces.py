...
OUTPUT_FILE = "output/custom_plots/knacke_capsule_force.png"
...
ax.plot(df['t'], df['capsule.f_z'], label='Payload Force', color='blue')
#ax.plot(df['t'], df['capsule.v_z'], label='Vertical Velocity', color='red', linestyle='--')

# Customize Axes
ax.set_title("Payload Force | Knacke parachute model")
